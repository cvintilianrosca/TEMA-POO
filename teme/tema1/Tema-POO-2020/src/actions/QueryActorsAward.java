...
public class QueryActorsAward {
    private Input input;
    private ActionInputData actionInputData;
    private Writer fileWriter;
    private JSONArray arrayResult;

    public QueryActorsAward(Input input, ActionInputData actionInputData, Writer fileWriter,JSONArray arrayResult){
        this.input=input;
    ...
    public StringBuilder executeCommand(){
        ...
        List<String> listAwardsInput= actionInputData.getFilters().get(3);
