...
public class QueryVideoMostViewedShow {
    ...
    public QueryVideoMostViewedShow(Input input, ActionInputData actionInputData, Writer fileWriter,JSONArray arrayResult){
        this.input=input;
