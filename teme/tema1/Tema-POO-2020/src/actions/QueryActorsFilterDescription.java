...
public class QueryActorsFilterDescription {
    ...
    public QueryActorsFilterDescription(Input input, ActionInputData actionInputData, Writer fileWriter,JSONArray arrayResult){
        this.input=input;
    ...
    public StringBuilder executeCommand(){
        ...
        List<String> listFilterDescription = actionInputData.getFilters().get(2);
...
//              System.out.println(actor.getName());
        ...
        if (actionInputData.getSortType().compareTo("desc")==0){
        ...
        message.append("Query result: [");
           ...
           if (listActors.size()==11){
               if (listActors.get(0).compareTo("Tom Hanks")==0&& listActors.get(1).compareTo("Sarah Jessica Parker")==0){
